    ...
    <div className=" relative min-h-screen">
      ...
      <div className=" container h-[calc(100vh-120vh)] grid items-center ">
        <div className=" space-y-4 bg-[#ffffff98] w-fit p-4 ">
          ...
          <button className=" bg-green-500 px-6 hover:bg-green-600 py-2 rounded-3xl justify-center items-center text-[18px] sm:text-[17px] ">
            {" "}
            View more
          </button>
        </div>
